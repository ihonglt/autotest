...
RDS="alijoin"
PACKAGE_URL="http://rdsbak-hzi-v2.oss-cn-hangzhou-i.aliyuncs.com/custins2430373/hins4466495_data_20180628132643.tar.gz?OSSAccessKeyId=LTAITfQ7krsrEwRn&Expires=1530364678&Signature=RGckzyhajB%2BKEYSiIuSDboqHf2U%3D"
...
docker run -ti --name $RDS-server -p 3307:3306 \
